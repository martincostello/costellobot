    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((configBuilder) =>
        {
            ...
            var config = new[]
            {
                ...
                KeyValuePair.Create<string, string?>($"GitHub:Apps:3842668:ClientId", "benchmarks-client-id"),
                KeyValuePair.Create<string, string?>($"GitHub:Apps:3842668:PrivateKey", testKey),
